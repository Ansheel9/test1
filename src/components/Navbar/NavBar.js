            ...
            >
              ...
              //   style="{{@media (min-width: 1024px) {margin-right: 20px}}}"
                ...
                <li class="flex items-center ml-5">
                    <button
                    class="bg-green-50 hover:bg-green-200 text-white active:bg-green-600 text-sm font-bold uppercase px-5 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                    type="button"
                  >
                    Get Started 
                  </button>
