...
export const Savings = () => {
    return (
		<section class="bg-white py-10 relative">
            <img class="hidden  lg:block lg:absolute -inset-y-32 inset-x-96 ml-64 transform hover:scale-110 " src={"/assets/images/MaskGroup.svg"} alt=""/>
            ...
            <div class="container relative mx-auto flex flex-col justify-center sm:py-12 lg:py-12 lg:flex-row lg:justify-between">
                <div class="flex bg-white flex-col justify-center lg:-ml-20  text-left lg:border rounded-br-3xl lg:shadow-2xl lg:max-w-3xl lg:text-left">
                    <span className=""></span>
                    <div class="flex py-2 lg:ml-xl w-80  -mt-8 rounded-t-xl shadow-2xl bg-green-50"  >
