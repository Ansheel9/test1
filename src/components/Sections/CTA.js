...
export const CTA = () => {
    return (
        <section class=" py-2 lg:mb-20 lg:mt-40 bg-green-50 text-gray-900 border rounded-lg lg:mx-32 ">
            <div class="container mx-auto flex flex-col justify-around p-4 text-center lg:py-8 lg:px-12 lg:flex-row">
                <div class="flex flex-col justify-center lg:text-left">
                    <h1 class="py-2 font-bold text-white leading-tight tracking-normal " style={{ fontSize: 44 }} >
                    Sign up today <br />
                    on Wealthbuddy App.
                    </h1>
                </div>
                <div class="flex flex-col items-center justify-center flex-shrink-0 mt-6 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 lg:ml-4 lg:mt-0 lg:justify-end">
                    <button class=" inline-flex items-center px-6 py-2 rounded-lg bg-white text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-current w-7 h-10 text-coolGray-50">
                        ...
                        <span class=" flex flex-col items-start ml-4 leading-none">
                            ...
                            <span class="font-semibold title-font">Play Store</span>
                        </span>
                    </button>
                    <button class=" inline-flex items-center px-5 py-3 rounded-lg bg-white text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" class="fill-current w-7 h-7 text-coolGray-50">
